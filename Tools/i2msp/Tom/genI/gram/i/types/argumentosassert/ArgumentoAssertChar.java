...
public final class ArgumentoAssertChar extends gram.i.types.ArgumentosAssert implements tom.library.sl.Visitable  {
  
  private static String symbolName = "ArgumentoAssertChar";


  private ArgumentoAssertChar() {}
  private int hashCode;
  private static ArgumentoAssertChar gomProto = new ArgumentoAssertChar();
    private String _Char;

  /**
   * Constructor that builds a term rooted by ArgumentoAssertChar
   *
   * @return a term rooted by ArgumentoAssertChar
   */

  public static ArgumentoAssertChar make(String _Char) {

    // use the proto as a model
    gomProto.initHashCode( _Char);
    return (ArgumentoAssertChar) factory.build(gomProto);
   ...
   *
   * @param  _Char
   * @param hashCode hashCode of ArgumentoAssertChar
   */
  ...
  public shared.SharedObject duplicate() {
    ArgumentoAssertChar clone = new ArgumentoAssertChar();
  ...
  public void toStringBuilder(java.lang.StringBuilder buffer) {
    buffer.append("ArgumentoAssertChar(");
    buffer.append('"');
  ...
  public int compareToLPO(Object o) {
    ...
    ArgumentoAssertChar tco = (ArgumentoAssertChar) ao;
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a ArgumentoAssertChar and its members are equal, else false
   */
  public final boolean equivalent(shared.SharedObject obj) {
    if(obj instanceof ArgumentoAssertChar) {

      ArgumentoAssertChar peer = (ArgumentoAssertChar) obj;
   ...
   *
   * @return true, because this is rooted by ArgumentoAssertChar
   */
  @Override
   ...
   */
  @Override
  public gram.i.types.ArgumentosAssert setChar(String set_arg) {
    return make(set_arg);
  }
