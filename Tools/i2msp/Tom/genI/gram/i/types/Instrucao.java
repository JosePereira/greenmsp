...
public abstract class Instrucao extends gram.i.iAbstractType  {
  ...
  /**
   * Returns the subterm corresponding to the slot ArgumentosAssert
   *
   * @return the subterm corresponding to the slot ArgumentosAssert
   */
  public gram.i.types.ArgumentosAssert getArgumentosAssert() {
    throw new UnsupportedOperationException("This Instrucao has no ArgumentosAssert");
  }

  /**
   * Returns a new term where the subterm corresponding to the slot ArgumentosAssert
   * is replaced by the term given in argument.
   * Note that there is no side-effect: a new term is returned and the original term is left unchanged
   *
   * @param _arg the value of the new subterm
   * @return a new term where the subterm corresponding to the slot ArgumentosAssert is replaced by _arg
   */
  public Instrucao setArgumentosAssert(gram.i.types.ArgumentosAssert _arg) {
    throw new UnsupportedOperationException("This Instrucao has no ArgumentosAssert");
  }
  ...
  /**
   * Returns the subterm corresponding to the slot ExpectedAssert
   *
   * @return the subterm corresponding to the slot ExpectedAssert
   */
  public gram.i.types.ExpectedAssert getExpectedAssert() {
    throw new UnsupportedOperationException("This Instrucao has no ExpectedAssert");
  }

  /**
   * Returns a new term where the subterm corresponding to the slot ExpectedAssert
   * is replaced by the term given in argument.
   * Note that there is no side-effect: a new term is returned and the original term is left unchanged
   *
   * @param _arg the value of the new subterm
   * @return a new term where the subterm corresponding to the slot ExpectedAssert is replaced by _arg
   */
  public Instrucao setExpectedAssert(gram.i.types.ExpectedAssert _arg) {
    throw new UnsupportedOperationException("This Instrucao has no ExpectedAssert");
  }
  ...
  public static gram.i.types.Instrucao fromTerm(aterm.ATerm trm, tom.library.utils.ATermConverter atConv) {
    ...
    tmp = gram.i.types.instrucao.Assert.fromTerm(convertedTerm,atConv);
    if(tmp!=null) {
      results.add(tmp);
    }
  ...
  protected static tom.library.enumerator.Enumeration<gram.i.types.Instrucao> enumInstrucao = null;
  public static final tom.library.enumerator.Enumeration<gram.i.types.Instrucao> tmpenumInstrucao = new tom.library.enumerator.Enumeration<gram.i.types.Instrucao>((tom.library.enumerator.LazyList<tom.library.enumerator.Finite<gram.i.types.Instrucao>>) null);

  public static tom.library.enumerator.Enumeration<gram.i.types.Instrucao> getEnumeration() {
    if(enumInstrucao == null) { 
      enumInstrucao = gram.i.types.instrucao.Atribuicao.funMake().apply(gram.i.types.LComentarios.tmpenumLComentarios).apply(tom.library.enumerator.Combinators.makeString()).apply(gram.i.types.LComentarios.tmpenumLComentarios).apply(gram.i.types.OpAtribuicao.tmpenumOpAtribuicao).apply(gram.i.types.LComentarios.tmpenumLComentarios).apply(gram.i.types.Expressao.tmpenumExpressao).apply(gram.i.types.LComentarios.tmpenumLComentarios)
        .plus(gram.i.types.instrucao.Declaracao.funMake().apply(gram.i.types.LComentarios.tmpenumLComentarios).apply(gram.i.types.DefTipo.tmpenumDefTipo).apply(gram.i.types.LComentarios.tmpenumLComentarios).apply(gram.i.types.Declaracoes.tmpenumDeclaracoes).apply(gram.i.types.LComentarios.tmpenumLComentarios).apply(gram.i.types.LComentarios.tmpenumLComentarios))
        .plus(gram.i.types.instrucao.If.funMake().apply(gram.i.types.LComentarios.tmpenumLComentarios).apply(gram.i.types.LComentarios.tmpenumLComentarios).apply(gram.i.types.LComentarios.tmpenumLComentarios).apply(gram.i.types.Expressao.tmpenumExpressao).apply(gram.i.types.LComentarios.tmpenumLComentarios).apply(gram.i.types.LComentarios.tmpenumLComentarios).apply(gram.i.types.Instrucao.tmpenumInstrucao).apply(gram.i.types.Instrucao.tmpenumInstrucao))
        .plus(gram.i.types.instrucao.While.funMake().apply(gram.i.types.LComentarios.tmpenumLComentarios).apply(gram.i.types.LComentarios.tmpenumLComentarios).apply(gram.i.types.LComentarios.tmpenumLComentarios).apply(gram.i.types.Expressao.tmpenumExpressao).apply(gram.i.types.LComentarios.tmpenumLComentarios).apply(gram.i.types.LComentarios.tmpenumLComentarios).apply(gram.i.types.Instrucao.tmpenumInstrucao).apply(gram.i.types.LComentarios.tmpenumLComentarios))
        .plus(gram.i.types.instrucao.For.funMake().apply(gram.i.types.LComentarios.tmpenumLComentarios).apply(gram.i.types.LComentarios.tmpenumLComentarios).apply(gram.i.types.Instrucao.tmpenumInstrucao).apply(gram.i.types.LComentarios.tmpenumLComentarios).apply(gram.i.types.Expressao.tmpenumExpressao).apply(gram.i.types.LComentarios.tmpenumLComentarios).apply(gram.i.types.LComentarios.tmpenumLComentarios).apply(gram.i.types.Expressao.tmpenumExpressao).apply(gram.i.types.LComentarios.tmpenumLComentarios).apply(gram.i.types.LComentarios.tmpenumLComentarios).apply(gram.i.types.Instrucao.tmpenumInstrucao).apply(gram.i.types.LComentarios.tmpenumLComentarios))
        .plus(gram.i.types.instrucao.Return.funMake().apply(gram.i.types.LComentarios.tmpenumLComentarios).apply(gram.i.types.LComentarios.tmpenumLComentarios).apply(gram.i.types.Expressao.tmpenumExpressao).apply(gram.i.types.LComentarios.tmpenumLComentarios))
        .plus(gram.i.types.instrucao.Assert.funMake().apply(tom.library.enumerator.Combinators.makeString()).apply(gram.i.types.ArgumentosAssert.tmpenumArgumentosAssert).apply(gram.i.types.ExpectedAssert.tmpenumExpectedAssert))
        .plus(gram.i.types.instrucao.Funcao.funMake().apply(gram.i.types.LComentarios.tmpenumLComentarios).apply(gram.i.types.DefTipo.tmpenumDefTipo).apply(gram.i.types.LComentarios.tmpenumLComentarios).apply(tom.library.enumerator.Combinators.makeString()).apply(gram.i.types.LComentarios.tmpenumLComentarios).apply(gram.i.types.LComentarios.tmpenumLComentarios).apply(gram.i.types.Argumentos.tmpenumArgumentos).apply(gram.i.types.LComentarios.tmpenumLComentarios).apply(gram.i.types.LComentarios.tmpenumLComentarios).apply(gram.i.types.Instrucao.tmpenumInstrucao).apply(gram.i.types.LComentarios.tmpenumLComentarios))
        .plus(gram.i.types.instrucao.Exp.funMake().apply(gram.i.types.Expressao.tmpenumExpressao));

      gram.i.types.DefTipo.getEnumeration();
      gram.i.types.Argumentos.getEnumeration();
      gram.i.types.ExpectedAssert.getEnumeration();
      gram.i.types.OpAtribuicao.getEnumeration();
      gram.i.types.Declaracoes.getEnumeration();
      gram.i.types.ArgumentosAssert.getEnumeration();
      gram.i.types.LComentarios.getEnumeration();
      gram.i.types.Expressao.getEnumeration();

      tmpenumInstrucao.p1 = new tom.library.enumerator.P1<tom.library.enumerator.LazyList<tom.library.enumerator.Finite<gram.i.types.Instrucao>>>() {
        public tom.library.enumerator.LazyList<tom.library.enumerator.Finite<gram.i.types.Instrucao>> _1() { return enumInstrucao.parts(); }
      };

    }
    return enumInstrucao;
  }
