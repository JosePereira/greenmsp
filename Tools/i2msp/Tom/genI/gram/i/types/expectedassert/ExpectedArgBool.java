...
public final class ExpectedArgBool extends gram.i.types.ExpectedAssert implements tom.library.sl.Visitable  {
  
  private static String symbolName = "ExpectedArgBool";


  private ExpectedArgBool() {}
  private int hashCode;
  private static ExpectedArgBool gomProto = new ExpectedArgBool();
    private String _BoolAssert;

  /**
   * Constructor that builds a term rooted by ExpectedArgBool
   *
   * @return a term rooted by ExpectedArgBool
   */

  public static ExpectedArgBool make(String _BoolAssert) {

    // use the proto as a model
    gomProto.initHashCode( _BoolAssert);
    return (ExpectedArgBool) factory.build(gomProto);
   ...
   *
   * @param  _BoolAssert
   * @param hashCode hashCode of ExpectedArgBool
   */
  ...
  public shared.SharedObject duplicate() {
    ExpectedArgBool clone = new ExpectedArgBool();
  ...
  public int compareToLPO(Object o) {
    ...
    ExpectedArgBool tco = (ExpectedArgBool) ao;
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a ExpectedArgBool and its members are equal, else false
   */
  public final boolean equivalent(shared.SharedObject obj) {
    if(obj instanceof ExpectedArgBool) {

      ExpectedArgBool peer = (ExpectedArgBool) obj;
   ...
   *
   * @return true, because this is rooted by ExpectedArgBool
   */
  @Override
   ...
   */
  @Override
  public gram.i.types.ExpectedAssert setBoolAssert(String set_arg) {
    return make(set_arg);
  }
