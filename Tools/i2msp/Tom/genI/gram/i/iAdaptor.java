...
public class iAdaptor {
  public static shared.SharedObject getTerm(Tree tree) {
    ...
    switch (tree.getType()) {
      ...
      case 81:
        {
          ...
          res = gram.i.types.expectedassert.ExpectedArgInt.make(field0);
          break;
        }
      case 74:
        {
      ...
      case 68:
        {
          res = gram.i.types.argumentosassert.EmptyListaArgsAssert.make();
          for(int i = 0; i < tree.getChildCount(); i++) {
            gram.i.types.ArgumentosAssert elem = (gram.i.types.ArgumentosAssert)iAdaptor.getTerm(tree.getChild(i));
            gram.i.types.argumentosassert.ListaArgsAssert list = (gram.i.types.argumentosassert.ListaArgsAssert) res;
      ...
      case 66:
        {
          ...
          String field0 = tree.getChild(0).getText();
          res = gram.i.types.argumentosassert.ArgumentoAssertChar.make(field0);
          break;
        }
      case 31:
        {
      ...
      case 65:
        {
          ...
          String field0 = tree.getChild(0).getText();
          res = gram.i.types.argumentosassert.ArgumentoAssertBool.make(field0);
          break;
        }
      case 64:
        {
      ...
      case 67:
        {
          ...
          int field0 = Integer.parseInt(tree.getChild(0).getText());
          res = gram.i.types.argumentosassert.ArgumentoAssertInt.make(field0);
          break;
        }
      case 76:
        {
      ...
      case 78:
        {
          ...
          res = gram.i.types.expectedassert.ExpectedArgComp.make(field0, field1);
          break;
        }
      case 24:
        {
      ...
      case 13:
        {
          ...
          String field0 = tree.getChild(0).getText();
          gram.i.types.ArgumentosAssert field1 = (gram.i.types.ArgumentosAssert)iAdaptor.getTerm(tree.getChild(1));
          gram.i.types.ExpectedAssert field2 = (gram.i.types.ExpectedAssert)iAdaptor.getTerm(tree.getChild(2));
          res = gram.i.types.instrucao.Assert.make(field0, field1, field2);
          break;
        }
      case 34:
        {
      ...
      case 82:
        {
          res = gram.i.types.expectedassert.EmptyExpAssert.make();
          for(int i = 0; i < tree.getChildCount(); i++) {
            gram.i.types.ExpectedAssert elem = (gram.i.types.ExpectedAssert)iAdaptor.getTerm(tree.getChild(i));
            gram.i.types.expectedassert.ExpAssert list = (gram.i.types.expectedassert.ExpAssert) res;
            res = list.append(elem);
          }
          break;
        }
      case 80:
        {
          ...
          String field0 = tree.getChild(0).getText();
          res = gram.i.types.expectedassert.ExpectedArgChar.make(field0);
          break;
        }
      case 30:
        {
      ...
      case 79:
        {
          ...
          String field0 = tree.getChild(0).getText();
          res = gram.i.types.expectedassert.ExpectedArgBool.make(field0);
          break;
        }
      case 16:
        {
